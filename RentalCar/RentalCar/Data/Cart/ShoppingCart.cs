...
namespace RentalCar.Data.Cart
{
    public class ShoppingCart
    {
        ...
        {
            var shoppingCartItem = _context.ShoppingCartItems.FirstOrDefault(n => n.Car.Id == car.Id &&
